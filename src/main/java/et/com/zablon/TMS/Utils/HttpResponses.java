...
public class HttpResponses {
    ...
    public static final String NOT_FOUND = "Sorry! There is no entity matching the given properites";
    public static final String NOT_FOUND_BY_ID = "Sorry! There is no entity matching the given Id of ${id}";
    ...
    public static <T, K> String notFoundResponse(T obj, K k){
        return NOT_FOUND_BY_ID.replace("entity", Reflection.getClassName(obj)).replace("${id}", String.valueOf(k));
    }

    public static <T> String notFoundResponse(Class<T> t){
        return NOT_FOUND_BY_ID.replace("entity", Reflection.getClassName(t));
    }

    public static <T> String notFoundResponse(String name){
        return NOT_FOUND.replace("entity", name);
    }
